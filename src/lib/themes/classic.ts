...
export const classicThemes: Theme[] = [
  ...
  },
  {
    ...
    styles: {
      container: 'max-width: 100%; margin: 0 auto; padding: 24px 20px 48px 20px; font-family: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 1.6 !important; color: #1f2329 !important; background-color: #ffffff !important; word-wrap: break-word;',
      h1: 'font-size: 26px; font-weight: 600; color: #1f2329 !important; line-height: 1.4 !important; margin: 26px 0 10px; letter-spacing: -0.02em;',
      h2: 'font-size: 22px; font-weight: 600; color: #1f2329 !important; line-height: 1.4 !important; margin: 22px 0 8px; letter-spacing: -0.02em;',
      h3: 'font-size: 18px; font-weight: 600; color: #1f2329 !important; line-height: 1.4 !important; margin: 18px 0 6px; letter-spacing: -0.02em;',
      h4: 'font-size: 16px; font-weight: 600; color: #1f2329 !important; line-height: 1.4 !important; margin: 16px 0 4px;',
      p: 'margin: 8px 0 !important; line-height: 1.6 !important; color: #1f2329 !important;',
      strong: 'font-weight: 600; color: #1f2329 !important;',
      em: 'font-style: italic; color: #1f2329 !important;',
      a: 'color: #3370ff !important; text-decoration: none;',
      ul: 'margin: 8px 0; padding-left: 24px;',
      ol: 'margin: 8px 0; padding-left: 24px;',
      li: 'margin: 4px 0; line-height: 1.6 !important; color: #1f2329 !important;',
      blockquote: 'margin: 12px 0; padding: 0 0 0 12px; background-color: transparent !important; border-left: 3px solid #dee0e3; color: #1f2329 !important; border-radius: 0;',
      code: 'font-family: "SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; padding: 2px 4px; background-color: #f5f6f7 !important; color: #1f2329 !important; border-radius: 3px; font-size: 13px !important; line-height: 1.5 !important;',
      pre: 'margin: 12px 0; padding: 16px; background-color: #f5f6f7 !important; border-radius: 6px; overflow-x: auto; font-size: 13px !important; line-height: 1.5 !important;',
      hr: 'margin: 16px auto; border: none; height: 1px; background-color: #dee0e3 !important; width: 100%;',
      ...
      th: 'background-color: #f5f6f7 !important; padding: 8px 12px; text-align: left; font-weight: 600; color: #1f2329 !important; border: 1px solid #dee0e3;',
      td: 'padding: 8px 12px; border: 1px solid #dee0e3; color: #1f2329 !important;',
      tr: 'border: none;',
    }
  },
  {
